...
def plot_stacked_area_chart(labels, stacked_info, stack_name=None, colors=None, xlabel=None, ylabel=None, title=None,
                            top_title=None, ylim=None, figsize=None, yerr=None):
...
def plot_bar(numbers, names=None, colors=None, ylabel=None, title=None, top_title=None, ylim=None, figsize=None,
             yerr=None):
    n_bars = len(numbers)  # numbers of bar-graph
