...
if __name__ == '__main__':
    ...
    args = options.handle_inputs(
        single_task=False, not_include=["perm"], filename="_compare_N-MNIST",
    ...
    args.iters = 100 if args.batch == 128 else 50
    args.acc_log = args.iters / 10
    args.n_kc = 1000
    args.k_num = 10
    args.lr = 0.005
    args.min_max = True
    ...
    # name for plot
    plot_name = "summary-{}{}-{}".format(f"{args.experiment}-{args.T}-{args.batch}-", args.tasks, args.scenario)
